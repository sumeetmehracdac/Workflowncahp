...
export const sampleWorkflows: WorkflowDefinition[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'roleNode',
        position: { x: 80, y: 210 },
        data: { label: 'Verification Officer — NCAHP', stage: 'validation' },
      },
      {
        id: 'r-e1',
        type: 'roleNode',
        position: { x: 80, y: 390 },
        data: { label: 'Deputy Secretary — NCAHP', stage: 'evaluation1' },
      },
      {
        id: 'r-e2a',
        type: 'roleNode',
      ...
      },
      {
        ...
        data: { label: 'Joint Secretary — NCAHP', stage: 'evaluation2' },
      },
    ],
    edges: [
      ...
      { id: 'e5', source: 'r-e1',  target: 'r-v1',  type: 'actionEdge', data: { action: 'return' } },
      { id: 'e6', source: 'r-e2a', target: 'r-e2b', type: 'actionEdge', data: { action: 'approve' } },
      { id: 'e7', source: 'r-e2a', target: 'r-e1',  type: 'actionEdge', data: { action: 'reject' } },
      { id: 'e8', source: 'r-e2b', target: 'r-e1',  type: 'actionEdge', data: { action: 'send_back' } },
    ],
  ...
  },
  {
    ...
    nodes: [
      {
        ...
        type: 'roleNode',
        position: { x: 80, y: 30 },
        data: { label: 'Section Officer — NCAHP', stage: 'submission' },
      },
      {
        id: 'r-v1',
        type: 'roleNode',
        position: { x: 80, y: 210 },
        data: { label: 'Registrar — State Council (HP)', stage: 'validation' },
      },
      {
        id: 'r-e1',
        type: 'roleNode',
        position: { x: 80, y: 390 },
        data: { label: 'President — State Council (HP)', stage: 'evaluation1' },
      },
      {
        id: 'r-e2',
        type: 'roleNode',
    ...
    edges: [
      ...
      { id: 'e2', source: 'r-v1', target: 'r-e1', type: 'actionEdge', data: { action: 'approve' } },
      { id: 'e3', source: 'r-v1', target: 'r-s1', type: 'actionEdge', data: { action: 'send_back' } },
      { id: 'e4', source: 'r-e1', target: 'r-e2', type: 'actionEdge', data: { action: 'approve' } },
      { id: 'e5', source: 'r-e1', target: 'r-v1', type: 'actionEdge', data: { action: 'return' } },
    ],
